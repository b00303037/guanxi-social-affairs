  ...
  fg = new FormGroup(
    {
      ...
      startHours: new FormControl({ value: null, disabled: true }),
      startMinutes: new FormControl({ value: null, disabled: true }),
      endDate: new FormControl(null),
      endHours: new FormControl({ value: null, disabled: true }),
      endMinutes: new FormControl({ value: null, disabled: true }),
    },
    {
